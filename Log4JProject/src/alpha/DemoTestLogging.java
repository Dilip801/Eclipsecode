...
public class DemoTestLogging {
private static Logger log =LogManager.getLogger(DemoTestLogging.class.getName());
...
//log.info(driver.findElements(By.tagName("iframe")).size());
